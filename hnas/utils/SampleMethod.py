...
class theSM():
    def __init__(self, method="random"):
        ...
        self.the_cfg = {
            ...
            'c1': [1.0, 0.95, 0.9],  # channel ratio
            'c2': [1.0, 0.95, 0.9, 0.85, 0.80],  # channel ratio
            'c3': [1.0, 0.95, 0.9, 0.85, 0.80, 0.75, 0.7]  # channel ratio
        }
            ...
            for key, v in self.ofa_layers.items():
                ...
                if v:
                    if layer>=0 and layer <=10:
                        out_dict[key] = {'expand_ratio': random.choice(self.the_cfg['c1'])}
                    elif layer>=11 and layer <=18:
                        out_dict[key] = {'expand_ratio': random.choice(self.the_cfg['c2'])}
                    elif layer>=19 :
                        out_dict[key] = {'expand_ratio': random.choice(self.the_cfg['c3'])}
